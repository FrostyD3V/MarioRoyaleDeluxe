...
public class PacketG12 extends Packet {
  ...
  public static class NamePair {
    ...
    public final boolean isDev, isMod;
    public NamePair(short id, String username, String name, boolean isDev, boolean isMod) {
      this.id = id; this.username = username; this.name = name; this.isDev = isDev; this.isMod = isMod;
    }
  }
}
